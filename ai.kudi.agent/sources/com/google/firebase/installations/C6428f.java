...
class C6428f {
    ...
    /* renamed from: a */
    private final FileChannel f15521a;

    /* renamed from: b */
    private final FileLock f15522b;

    private C6428f(FileChannel fileChannel, FileLock fileLock) {
        this.f15521a = fileChannel;
        this.f15522b = fileLock;
    }
    ...
    */
    public static com.google.firebase.installations.C6428f m22077a(android.content.Context r4, java.lang.String r5) {
        /*
            r0 = 0
            ...
            com.google.firebase.installations.f r1 = new com.google.firebase.installations.f     // Catch: java.nio.channels.OverlappingFileLockException -> L1f java.lang.Error -> L21 java.io.IOException -> L23
        ...
        L46:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.C6428f.m22077a(android.content.Context, java.lang.String):com.google.firebase.installations.f");
    }
