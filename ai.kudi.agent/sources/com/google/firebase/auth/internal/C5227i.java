...
public final class C5227i {
    /* renamed from: a */
    public static Status m25323a(String str) {
        String str2;
        if (!TextUtils.isEmpty(str)) {
            ...
            if (asList.size() > 1) {
                return m25322b((String) asList.get(0), (String) asList.get(1));
            }
            return m25322b((String) asList.get(0), null);
        }
    ...
    /* renamed from: b */
    private static Status m25322b(String str, String str2) {
        char c;
        int i;
        switch (str.hashCode()) {
            case -2130504259:
