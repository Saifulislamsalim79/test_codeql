...
public final class C3528td implements Parcelable.Creator<C3502sd> {
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3502sd createFromParcel(Parcel parcel) {
        ...
        return new C3502sd(c5266p, str);
    }

    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3502sd[] newArray(int i) {
        return new C3502sd[i];
    }
}
