...
public final class C3607we implements Parcelable.Creator<C3581ve> {
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3581ve createFromParcel(Parcel parcel) {
        ...
        return new C3581ve(str, str2, str3);
    }

    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3581ve[] newArray(int i) {
        return new C3581ve[i];
    }
}
