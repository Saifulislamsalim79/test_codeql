...
public final class C3105de implements Parcelable.Creator<C3078ce> {
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3078ce createFromParcel(Parcel parcel) {
        ...
        return new C3078ce(str, c5266p);
    }

    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3078ce[] newArray(int i) {
        return new C3078ce[i];
    }
}
