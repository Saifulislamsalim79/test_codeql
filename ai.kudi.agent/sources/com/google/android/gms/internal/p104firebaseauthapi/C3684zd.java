...
public final class C3684zd implements Parcelable.Creator<C3658yd> {
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3658yd createFromParcel(Parcel parcel) {
        ...
        return new C3658yd(str, str2, str3);
    }

    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ C3658yd[] newArray(int i) {
        return new C3658yd[i];
    }
}
