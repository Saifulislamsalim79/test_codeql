...
/* renamed from: com.google.android.gms.internal.firebase-auth-api.qi */
/* loaded from: classes2.dex */
public final class C3455qi extends AbstractC3379nk<Object, InterfaceC5216c0> {

    /* renamed from: v */
    private final C3529te f8890v;

    public C3455qi(String str, String str2) {
        super(2);
        s.g(str, "token cannot be null or empty");
        this.f8890v = new C3529te(str, str2);
    }
    ...
    /* renamed from: k */
    public final /* synthetic */ void m30425k(InterfaceC3083cj interfaceC3083cj, C4465k c4465k) throws RemoteException {
        this.f8780u = new C3353mk(this, c4465k);
        interfaceC3083cj.mo31239e().mo30347t(this.f8890v, this.f8761b);
    }
    ...
    public final AbstractC2796p<InterfaceC3083cj, Object> zza() {
        ...
        m31935a.m31930b(new InterfaceC2790n() { // from class: com.google.android.gms.internal.firebase-auth-api.pi
            @Override // com.google.android.gms.common.api.internal.InterfaceC2790n
            /* renamed from: a */
            public final void mo16126a(Object obj, Object obj2) {
                C3455qi.this.m30425k((InterfaceC3083cj) obj, (C4465k) obj2);
            }
        });
