...
final class C3935p2 extends AbstractRunnableC3873l2 {

    /* renamed from: w */
    final /* synthetic */ Activity f9610w;

    /* renamed from: x */
    final /* synthetic */ C4030v2 f9611x;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3935p2(C4030v2 c4030v2, Activity activity) {
        super(c4030v2.f9792c, true);
        this.f9611x = c4030v2;
        this.f9610w = activity;
    }
    ...
    final void mo28583a() throws RemoteException {
        f1 f1Var;
        f1Var = this.f9611x.f9792c.f9814h;
        com.google.android.gms.common.internal.s.j(f1Var);
        f1Var.onActivityResumed(BinderC2989b.m31494p1(this.f9610w), this.f9459d);
    }
}
