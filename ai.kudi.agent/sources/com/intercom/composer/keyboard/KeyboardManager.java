...
class KeyboardManager implements ViewTreeObserver.OnGlobalLayoutListener, OnKeyboardVisibilityListener {
    ...
    public int getKeyboardHeight(int i) {
        ...
        if (i == 1) {
            return this.sharedPreferences.getInt(KEY_KEYBOARD_HEIGHT_PORTRAIT, resources.getDimensionPixelSize(C7163R.dimen.intercom_composer_keyboard_portrait_height));
        }
        return resources.getDimensionPixelSize(C7163R.dimen.intercom_composer_keyboard_landscape_height);
    }
