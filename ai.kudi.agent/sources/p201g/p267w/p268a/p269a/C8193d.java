...
public class C8193d {
    ...
    */
    private static android.view.animation.Interpolator m16548a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            int r3 = r5.getDepth()
            r4 = 0
        L5:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p201g.p267w.p268a.p269a.C8193d.m16548a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }

    /* renamed from: b */
    public static Interpolator m16547b(Context context, int i) throws Resources.NotFoundException {
        ...
        try {
            try {
                ...
                Interpolator m16548a = m16548a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return m16548a;
