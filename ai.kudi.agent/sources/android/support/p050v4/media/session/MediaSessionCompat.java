...
import android.support.p050v4.media.MediaDescriptionCompat;
import android.support.p050v4.media.MediaMetadataCompat;
import android.support.p050v4.media.RatingCompat;
import android.support.p050v4.media.session.IMediaSession;
import android.support.p050v4.media.session.MediaSessionCompatApi21;
import android.support.p050v4.media.session.MediaSessionCompatApi23;
import android.support.p050v4.media.session.MediaSessionCompatApi24;
...
import androidx.media.AbstractC1598f;
import androidx.media.C1594b;
import androidx.media.p061g.C1600a;
...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((C1594b) message.obj);
                }
            }
        }
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            @Override // android.support.p050v4.media.session.MediaSessionCompatApi21.Callback
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            C1306f.m36441b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
        ...
        private class StubApi23 extends StubApi21 implements MediaSessionCompatApi23.Callback {
            ...
            @Override // android.support.p050v4.media.session.MediaSessionCompatApi23.Callback
        ...
        private class StubApi24 extends StubApi23 implements MediaSessionCompatApi24.Callback {
            ...
            @Override // android.support.p050v4.media.session.MediaSessionCompatApi24.Callback
        ...
        void handleMediaPlayPauseKeySingleTapIfPending(C1594b c1594b) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(c1594b);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            C1594b currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        C1594b getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(C1594b c1594b);
        ...
        void setPlaybackToRemote(AbstractC1598f abstractC1598f);
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplBase
        ...
        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplBase, android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplApi18, android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplBase
        int getRccTransportControlFlagsFromActions(long j) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j);
            return (j & 128) != 0 ? rccTransportControlFlagsFromActions | IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED : rccTransportControlFlagsFromActions;
        }

        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplApi18, android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplBase, android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCallback(Callback callback, Handler handler) {
            super.setCallback(callback, handler);
            if (callback == null) {
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final C1594b getCurrentControllerInfo() {
            return new C1594b(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(C1594b c1594b) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private C1594b mRemoteUserInfo;
        int mRepeatMode;
        ...
        AbstractC1598f mVolumeProvider;
        int mVolumeType;
        ...
        private AbstractC1598f.AbstractC1599a mVolumeCallback = new AbstractC1598f.AbstractC1599a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // androidx.media.AbstractC1598f.AbstractC1599a
            public void onVolumeChanged(AbstractC1598f abstractC1598f) {
                if (MediaSessionImplBase.this.mVolumeProvider != abstractC1598f) {
                    return;
                }
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                int i = mediaSessionImplBase.mVolumeType;
                int i2 = mediaSessionImplBase.mLocalStream;
                abstractC1598f.m35461a();
                throw null;
            }
        };
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            @Override // android.support.p050v4.media.session.IMediaSession
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    AbstractC1598f abstractC1598f = MediaSessionImplBase.this.mVolumeProvider;
                    if (i != 2) {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new C1594b("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new C1594b(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        void adjustVolume(int i, int i2) {
            if (this.mVolumeType == 2) {
                AbstractC1598f abstractC1598f = this.mVolumeProvider;
                if (abstractC1598f != null) {
                    abstractC1598f.m35459c(i);
                    return;
                }
                return;
            }
        ...
        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
        public String getCallingPackage() {
            return null;
        }

        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
        public C1594b getCurrentControllerInfo() {
            C1594b c1594b;
            synchronized (this.mLock) {
                c1594b = this.mRemoteUserInfo;
            }
            return c1594b;
        }
        ...
        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(AbstractC1598f abstractC1598f) {
            if (abstractC1598f != null) {
                AbstractC1598f abstractC1598f2 = this.mVolumeProvider;
                if (abstractC1598f2 != null) {
                    abstractC1598f2.m35457e(null);
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = abstractC1598f;
                this.mVolumeProvider.m35461a();
                throw null;
            }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(C1306f.m36442a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                C1306f.m36441b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public void setPlaybackToRemote(AbstractC1598f abstractC1598f) {
        if (abstractC1598f != null) {
            this.mImpl.setPlaybackToRemote(abstractC1598f);
            return;
        }
        throw new IllegalArgumentException("volumeProvider may not be null!");
    }
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = C1600a.m35456a(context)) == null) {
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new C1594b(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        @Override // android.support.p050v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(AbstractC1598f abstractC1598f) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, abstractC1598f.m35460b());
        }
