...
import android.support.p050v4.media.MediaBrowserCompatApi21;
import android.support.p050v4.media.MediaBrowserCompatApi23;
import android.support.p050v4.media.MediaBrowserCompatApi26;
import android.support.p050v4.media.session.IMediaSession;
import android.support.p050v4.media.session.MediaSessionCompat;
import android.support.p050v4.p051os.ResultReceiver;
import android.text.TextUtils;
import android.util.Log;
import androidx.core.app.C1306f;
import androidx.media.C1593a;
...
public final class MediaBrowserCompat {
    ...
    public static class ConnectionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.ConnectionCallback {
            ...
            @Override // android.support.p050v4.media.MediaBrowserCompatApi21.ConnectionCallback
    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        @Override // android.support.p050v4.p051os.ResultReceiver
    ...
    public static abstract class ItemCallback {
        ...
        private class StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
            ...
            @Override // android.support.p050v4.media.MediaBrowserCompatApi23.ItemCallback
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final C7521a<String, Subscription> mSubscriptions = new C7521a<>();
        ...
        @Override // android.support.p050v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void connect() {
        ...
        @Override // android.support.p050v4.media.MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
        public void onConnected() {
            ...
            IBinder m36442a = C1306f.m36442a(extras, "extra_messenger");
            if (m36442a != null) {
                this.mServiceBinderWrapper = new ServiceBinderWrapper(m36442a, this.mRootHints);
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(C1306f.m36442a(extras, "extra_session_binder"));
            if (asInterface != null) {
        ...
        @Override // android.support.p050v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
    ...
    static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        @Override // android.support.p050v4.media.MediaBrowserCompat.MediaBrowserImplApi21, android.support.p050v4.media.MediaBrowserCompat.MediaBrowserImpl
    ...
    public static class ServiceBinderWrapper {
        ...
        void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            C1306f.m36441b(bundle2, "data_callback_token", iBinder);
        ...
        void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            C1306f.m36441b(bundle, "data_callback_token", iBinder);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i = 0; i < this.mOptionsList.size(); i++) {
                if (C1593a.m35462a(this.mOptionsList.get(i), bundle)) {
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            @Override // android.support.p050v4.media.MediaBrowserCompatApi21.SubscriptionCallback
        ...
        private class StubApi26 extends StubApi21 implements MediaBrowserCompatApi26.SubscriptionCallback {
            ...
            @Override // android.support.p050v4.media.MediaBrowserCompatApi26.SubscriptionCallback
