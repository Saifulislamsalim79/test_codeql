...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    public class AndroidMediaPlayerListenerHolder implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnTimedTextListener {
        ...
        public void onBufferingUpdate(MediaPlayer mediaPlayer, final int i) {
            this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.5
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() == null) {
                        return;
                    }
        ...
        public void onCompletion(MediaPlayer mediaPlayer) {
            this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.6
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() == null) {
                        return;
        ...
        public boolean onError(MediaPlayer mediaPlayer, final int i, final int i2) {
            return this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.2
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() != null) {
        ...
        public boolean onInfo(MediaPlayer mediaPlayer, final int i, final int i2) {
            return this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.1
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() != null) {
        ...
        public void onPrepared(MediaPlayer mediaPlayer) {
            this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.7
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() == null) {
                        return;
        ...
        public void onSeekComplete(MediaPlayer mediaPlayer) {
            this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.4
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() == null) {
                        return;
        ...
        public void onTimedText(MediaPlayer mediaPlayer, final TimedText timedText) {
            this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.8
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() == null) {
                        return;
                    ...
                    AndroidMediaPlayer.this.notifyOnTimedText(timedText2 != null ? new IjkTimedText(timedText2.getBounds(), timedText.getText()) : null);
                }
            });
        }
        ...
        public void onVideoSizeChanged(MediaPlayer mediaPlayer, final int i, final int i2) {
            this.handler.post(new Runnable() { // from class: tv.danmaku.ijk.media.player.AndroidMediaPlayer.AndroidMediaPlayerListenerHolder.3
                @Override // java.lang.Runnable
                public void run() {
                    if (AndroidMediaPlayerListenerHolder.this.mWeakMediaPlayer.get() == null) {
                        return;
