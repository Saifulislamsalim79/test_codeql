...
public class NestedScrollView extends FrameLayout implements InterfaceC7749n, InterfaceC7746k, InterfaceC7757v {
    ...
    private final C7747l mChildHelper;
    ...
    private InterfaceC1385b mOnScrollChangeListener;
    private final C7751p mParentHelper;
    private C1386c mSavedState;
    ...
    private static final C1384a ACCESSIBILITY_DELEGATE = new C1384a();
    private static final int[] SCROLLVIEW_STYLEABLE = {16843130};

    /* renamed from: androidx.core.widget.NestedScrollView$a */
    /* loaded from: classes2.dex */
    static class C1384a extends C7676a {
        C1384a() {
        }
        ...
        public void mo17397f(View view, AccessibilityEvent accessibilityEvent) {
            ...
            C7724e.m17632a(accessibilityEvent, nestedScrollView.getScrollX());
            C7724e.m17631b(accessibilityEvent, nestedScrollView.getScrollRange());
        }
        ...
        public void mo17396g(View view, C7716c c7716c) {
            ...
            NestedScrollView nestedScrollView = (NestedScrollView) view;
            c7716c.m17693a0(ScrollView.class.getName());
            if (!nestedScrollView.isEnabled() || (scrollRange = nestedScrollView.getScrollRange()) <= 0) {
                return;
            }
            c7716c.m17653u0(true);
            if (nestedScrollView.getScrollY() > 0) {
                c7716c.m17692b(C7716c.C7717a.f18478i);
                c7716c.m17692b(C7716c.C7717a.f18482m);
            }
            if (nestedScrollView.getScrollY() < scrollRange) {
                c7716c.m17692b(C7716c.C7717a.f18477h);
                c7716c.m17692b(C7716c.C7717a.f18483n);
            }
        }
    ...
    public interface InterfaceC1385b {
        /* renamed from: a */
        void mo36157a(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: androidx.core.widget.NestedScrollView$c */
    /* loaded from: classes2.dex */
    public static class C1386c extends View.BaseSavedState {
        public static final Parcelable.Creator<C1386c> CREATOR = new C1387a();
        ...
        /* loaded from: classes2.dex */
        class C1387a implements Parcelable.Creator<C1386c> {
            C1387a() {
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: a */
            public C1386c createFromParcel(Parcel parcel) {
                return new C1386c(parcel);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: b */
            public C1386c[] newArray(int i) {
                return new C1386c[i];
            }
        }

        C1386c(Parcelable parcelable) {
            super(parcelable);
        }

        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f4253c + "}";
        }
    ...
    private void onNestedScrollInternal(int i, int i2, int[] iArr) {
        ...
        this.mChildHelper.m17593e(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
    ...
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        return this.mChildHelper.m17597a(f, f2, z);
    }

    @Override // android.view.View
    public boolean dispatchNestedPreFling(float f, float f2) {
        return this.mChildHelper.m17596b(f, f2);
    }

    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        return this.mChildHelper.m17594d(i, i2, iArr, iArr2, i3);
    }

    public void dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        this.mChildHelper.m17593e(i, i2, i3, i4, iArr, i5, iArr2);
    }
    ...
    public int getNestedScrollAxes() {
        return this.mParentHelper.m17578a();
    }
    ...
    public boolean hasNestedScrollingParent(int i) {
        return this.mChildHelper.m17586l(i);
    }
    ...
    public boolean isNestedScrollingEnabled() {
        return this.mChildHelper.m17585m();
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.mIsLaidOut) {
            if (this.mSavedState != null) {
                scrollTo(getScrollX(), this.mSavedState.f4253c);
    ...
    public void onNestedScrollAccepted(View view, View view2, int i, int i2) {
        this.mParentHelper.m17576c(view, view2, i, i2);
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        if (!(parcelable instanceof C1386c)) {
            super.onRestoreInstanceState(parcelable);
            return;
        }
        C1386c c1386c = (C1386c) parcelable;
        super.onRestoreInstanceState(c1386c.getSuperState());
        this.mSavedState = c1386c;
        requestLayout();
    }

    @Override // android.view.View
    protected Parcelable onSaveInstanceState() {
        C1386c c1386c = new C1386c(super.onSaveInstanceState());
        c1386c.f4253c = getScrollY();
        return c1386c;
    }
    ...
    protected void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        InterfaceC1385b interfaceC1385b = this.mOnScrollChangeListener;
        if (interfaceC1385b != null) {
            interfaceC1385b.mo36157a(this, i, i2, i3, i4);
        }
    }
    ...
    public void onStopNestedScroll(View view, int i) {
        this.mParentHelper.m17574e(view, i);
        stopNestedScroll(i);
    }
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (z) {
                            ...
                            int i7 = scrollY + i6;
                            if (i7 < 0) {
                                C1393d.m36118a(this.mEdgeGlowTop, i6 / getHeight(), motionEvent.getX(findPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i7 > scrollRange) {
                                C1393d.m36118a(this.mEdgeGlowBottom, i6 / getHeight(), 1.0f - (motionEvent.getX(findPointerIndex) / getWidth()));
                                if (!this.mEdgeGlowTop.isFinished()) {
    ...
    */
    ...
    public void setNestedScrollingEnabled(boolean z) {
        this.mChildHelper.m17584n(z);
    }

    public void setOnScrollChangeListener(InterfaceC1385b interfaceC1385b) {
        this.mOnScrollChangeListener = interfaceC1385b;
    }
    ...
    public boolean startNestedScroll(int i, int i2) {
        return this.mChildHelper.m17581q(i, i2);
    }

    public void stopNestedScroll(int i) {
        this.mChildHelper.m17579s(i);
    }

    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C7599a.nestedScrollViewStyle);
    }
    ...
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5) {
        return this.mChildHelper.m17591g(i, i2, i3, i4, iArr, i5);
    }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mParentHelper = new C7751p(this);
        this.mChildHelper = new C7747l(this);
        setNestedScrollingEnabled(true);
        C7759x.m17498p0(this, ACCESSIBILITY_DELEGATE);
    }
    ...
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.mChildHelper.m17592f(i, i2, i3, i4, iArr);
    }
