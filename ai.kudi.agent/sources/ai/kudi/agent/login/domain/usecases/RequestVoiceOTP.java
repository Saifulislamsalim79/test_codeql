...
public final class RequestVoiceOTP implements OneInputUseCase<ResetPinResponse, ResetPinRequest> {
    ...
    public AbstractC11688p execute(ai.kudi.agent.login.domain.wiki.ResetPinRequest resetPinRequest) {
        ...
        AbstractC11688p $r4 = $r3.receiveVoiceCall(resetPinRequest);
        Item $r5 = ClassWriter.LogError();
        AbstractC11688p $r42 = $r4.h0($r5);
        Item $r52 = ContextUtils.LogError();
        AbstractC11688p $r43 = $r42.R($r52);
        Log_OC.loadImage($r43, "networkService.onboardingApi.receiveVoiceCall(request)\n                .subscribeOn(Schedulers.io())\n                .observeOn(AndroidSchedulers.mainThread())");
        return $r43;
    }
