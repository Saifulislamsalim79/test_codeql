...
/* renamed from: ai.kudi.agent.login.setup.ui.UnknownDeviceDobFragment$onViewCreated$1$2 */
/* loaded from: classes.dex */
final class UnknownDeviceDobFragment$onViewCreated$1$2 extends AbstractC11802m implements InterfaceC11767l<View, C13666w> {
    final /* synthetic */ UnknownDeviceDobFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UnknownDeviceDobFragment$onViewCreated$1$2(UnknownDeviceDobFragment unknownDeviceDobFragment) {
        super(1);
