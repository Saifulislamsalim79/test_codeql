...
public final class AccountVerificationPresenter$resendOtp$1$2 extends AbstractC11802m implements InterfaceC11767l<Throwable, C13666w> {
    final /* synthetic */ AccountVerificationView $view;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountVerificationPresenter$resendOtp$1$2(AccountVerificationView accountVerificationView) {
        super(1);
    ...
    public final void invoke2(Throwable th) {
        ...
        $r22.showMsg("Something went wrong. Please contact support or try again");
    }
}
