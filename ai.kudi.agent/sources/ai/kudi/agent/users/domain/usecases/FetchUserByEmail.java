...
public class FetchUserByEmail implements OneInputUseCase<User, String> {
    ...
    private final Object throwAppropriateException() {
        HttpStatus r1 = HttpStatus.CONFLICT;
        return r1;
    }
    ...
    public static final void m41436throwAppropriateException$lambda0(Throwable th) {
    ...
    public AbstractC11688p execute(String str) {
        ...
        AbstractC11688p $r3 = $r2.isEmailAvailable(str);
        ...
        Log_OC.loadImage($r34, "userRepository.isEmailAvailable(email)\n                .subscribeOn(Schedulers.newThread())\n                .doOnError(throwAppropriateException())\n                .observeOn(AndroidSchedulers.mainThread())");
        return $r34;
    }
}
