...
/* compiled from: FetchUserByUsername.kt */
@Metadata(m10422d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0003\n\u0000\b\u0016\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u000f\b\u0007\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0016\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00020\b2\u0006\u0010\t\u001a\u00020\u0003H\u0016J\u000e\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bH\u0002R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, m10421d2 = {"Lai/kudi/agent/users/domain/usecases/FetchUserByUsername;", "Lai/kudi/agent/core/usecases/OneInputUseCase;", "Lai/kudi/agent/users/domain/dto/User;", "", "userRepository", "Lai/kudi/agent/users/data/repositories/UserRepository;", "(Lai/kudi/agent/users/data/repositories/UserRepository;)V", "execute", "Lio/reactivex/Observable;", CacheDataSource.PREF_USERNAME, "throwAppropriateException", "Lio/reactivex/functions/Consumer;", "", "app_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
/* loaded from: classes.dex */
public class FetchUserByUsername implements OneInputUseCase<User, String> {
    private final UserRepository userRepository;

    public FetchUserByUsername(UserRepository userRepository) {
    ...
    public static final void m41440throwAppropriateException$lambda0(Throwable th) {
    ...
    public AbstractC11688p execute(String str) {
        ...
        AbstractC11688p $r3 = $r2.isUsernameAvailable(str);
        ...
        Log_OC.loadImage($r34, "userRepository.isUsernameAvailable(username)\n                .subscribeOn(Schedulers.newThread())\n                .doOnError(throwAppropriateException())\n                .observeOn(AndroidSchedulers.mainThread())");
        return $r34;
    }
}
