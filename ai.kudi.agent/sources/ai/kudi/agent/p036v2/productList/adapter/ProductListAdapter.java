package ai.kudi.agent.p036v2.productList.adapter;
...
public final class ProductListAdapter extends BaseMarketplaceRecyclerViewAdapter<ProductListViewHolder> {
     ...
     */
    public ProductListAdapter(ProductItemOnClickListener productItemOnClickListener) {
    ...
    public static final void m41646onBindViewHolder$lambda0(ProductListAdapter productListAdapter, C11812w c11812w, ProductListViewHolder productListViewHolder, View view) {
        Log_OC.getArray(productListAdapter, "this$0");
        Log_OC.getArray(c11812w, "$currentItem");
        Log_OC.getArray(productListViewHolder, "$holder");
        ProductItemOnClickListener $r4 = productListAdapter.onItemClickListener;
    ...
    public void onBindViewHolder(final ProductListViewHolder productListViewHolder, int i) {
        ...
        $r7.setOnClickListener(new View.OnClickListener() { // from class: ai.kudi.agent.v2.productList.adapter.h
            /* JADX WARN: Can't parse signature for local variable: 
            java.lang.NullPointerException
             */
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ProductListAdapter $r22 = ProductListAdapter.this;
                C11812w $r32 = $r2;
                ProductListViewHolder $r42 = productListViewHolder;
                ProductListAdapter.m41646onBindViewHolder$lambda0($r22, $r32, $r42, view);
            }
        });
    }
