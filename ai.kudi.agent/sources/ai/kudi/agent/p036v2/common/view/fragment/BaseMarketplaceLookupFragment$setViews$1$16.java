...
/* renamed from: ai.kudi.agent.v2.common.view.fragment.BaseMarketplaceLookupFragment$setViews$1$16 */
/* loaded from: classes.dex */
public final class BaseMarketplaceLookupFragment$setViews$1$16 extends AbstractC11802m implements InterfaceC11756a<C13666w> {
    ...
    public BaseMarketplaceLookupFragment$setViews$1$16(BaseMarketplaceLookupFragment baseMarketplaceLookupFragment, Field field, C0768g c0768g) {
        super(0);
    ...
    public final void invoke2() {
        ...
        Field $r2 = this.$field;
        C0768g $r3 = this.$imageUploadButton;
        $r1.showCamera($r2, $r3);
    }
}
