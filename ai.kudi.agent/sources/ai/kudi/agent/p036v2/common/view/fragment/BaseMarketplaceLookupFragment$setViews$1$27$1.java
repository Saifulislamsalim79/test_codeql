...
/* renamed from: ai.kudi.agent.v2.common.view.fragment.BaseMarketplaceLookupFragment$setViews$1$27$1 */
/* loaded from: classes.dex */
public final class BaseMarketplaceLookupFragment$setViews$1$27$1 extends AbstractC11802m implements InterfaceC11767l<View, C13666w> {
    final /* synthetic */ ShortTextInputFieldView $this_apply;
    final /* synthetic */ BaseMarketplaceLookupFragment<VM, State> this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseMarketplaceLookupFragment$setViews$1$27$1(BaseMarketplaceLookupFragment baseMarketplaceLookupFragment, ShortTextInputFieldView shortTextInputFieldView) {
        super(1);
        this.this$0 = baseMarketplaceLookupFragment;
        this.$this_apply = shortTextInputFieldView;
    }
    ...
    public final void invoke2(View view) {
        ...
        ShortTextInputFieldView $r3 = this.$this_apply;
        $r2.showStates($r3);
    }
}
