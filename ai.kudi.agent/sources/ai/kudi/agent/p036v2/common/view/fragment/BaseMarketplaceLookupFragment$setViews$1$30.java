...
/* renamed from: ai.kudi.agent.v2.common.view.fragment.BaseMarketplaceLookupFragment$setViews$1$30 */
/* loaded from: classes.dex */
public final class BaseMarketplaceLookupFragment$setViews$1$30 extends AbstractC11802m implements InterfaceC11767l<View, C13666w> {
    ...
    public BaseMarketplaceLookupFragment$setViews$1$30(BaseMarketplaceLookupFragment baseMarketplaceLookupFragment, FormInputFieldView formInputFieldView) {
        super(1);
    ...
    public final void invoke2(View view) {
        ...
        FormInputFieldView $r3 = this.$inputFieldView;
        $r2.showLga($r3);
    }
}
