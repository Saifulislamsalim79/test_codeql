...
/* renamed from: ai.kudi.agent.v2.common.view.fragment.BaseMarketplaceLookupFragment$setViews$1$25 */
/* loaded from: classes.dex */
public final class BaseMarketplaceLookupFragment$setViews$1$25 extends AbstractC11802m implements InterfaceC11767l<View, C13666w> {
    ...
    public BaseMarketplaceLookupFragment$setViews$1$25(BaseMarketplaceLookupFragment baseMarketplaceLookupFragment, Field field, FormInputFieldView formInputFieldView, C11812w c11812w) {
        super(1);
    ...
    public final void invoke2(View view) {
        ...
        Map $r8 = this.this$0.getMapOfAssociatedFields();
        Field $r3 = this.$field;
        int $i0 = $r3.getId();
        String $r9 = String.valueOf($i0);
        Object $r10 = $r8.get($r9);
        List $r11 = (List) $r10;
        if ($r11 == null) {
            return;
        }
        FormInputFieldView $r1 = this.$inputFieldView;
        BaseMarketplaceLookupFragment $r4 = this.this$0;
        C11812w $r2 = this.$associatedFieldList;
        Field $r32 = this.$field;
        boolean $z02 = $r11.isEmpty();
        if (!$z02) {
            ShortTextInputFieldView $r12 = (ShortTextInputFieldView) $r1;
            String $r92 = $r12.getText();
            $z0 = C13276s.m5440u($r92);
            if ($z0) {
                C0819d r17 = new C0819d();
                r17.setItemList($r11);
                Context $r14 = $r4.requireContext();
                Log_OC.loadImage($r14, "requireContext()");
                BaseMarketplaceLookupFragment$setViews$1$25$1$1 r18 = new BaseMarketplaceLookupFragment$setViews$1$25$1$1(r17, $r1, $r2, $r4, $r32);
                C0813k r19 = new C0813k($r14, r17, r18);
                FragmentManager $r15 = $r4.getChildFragmentManager();
                String $r93 = C0813k.class.getCanonicalName();
