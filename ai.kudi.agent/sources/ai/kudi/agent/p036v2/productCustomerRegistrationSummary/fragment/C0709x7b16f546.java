...
/* renamed from: ai.kudi.agent.v2.productCustomerRegistrationSummary.fragment.ProductCustomerRegistrationSummaryFragment$special$$inlined$activityViewModels$default$1 */
/* loaded from: classes.dex */
public final class C0709x7b16f546 extends AbstractC11802m implements InterfaceC11756a<C1566i0> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0709x7b16f546(Fragment fragment) {
        super(0);
