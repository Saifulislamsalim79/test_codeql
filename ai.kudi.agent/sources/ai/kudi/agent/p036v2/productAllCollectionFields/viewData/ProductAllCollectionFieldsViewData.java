package ai.kudi.agent.p036v2.productAllCollectionFields.viewData;
...
public final class ProductAllCollectionFieldsViewData implements MarketplaceLookupViewData {
    ...
    public ProductAllCollectionFieldsViewData() {
        this(null, null, false, false, null, null, false, null, null, null, false, null, 4095, null);
    }

    public ProductAllCollectionFieldsViewData(ProductField productField, Error error, boolean z, boolean z2, List list, Error error2, boolean z3, Error error3, Map map, List list2, boolean z4, Error error4) {
    ...
    */
    public /* synthetic */ ProductAllCollectionFieldsViewData(ai.kudi.agent.core.domain.data.ProductField r25, ai.kudi.agent.p036v2.common.view.viewData.data.Error r26, boolean r27, boolean r28, java.util.List r29, ai.kudi.agent.p036v2.common.view.viewData.data.Error r30, boolean r31, ai.kudi.agent.p036v2.common.view.viewData.data.Error r32, java.util.Map r33, java.util.List r34, boolean r35, ai.kudi.agent.p036v2.common.view.viewData.data.Error r36, int r37, kotlin.p483e0.p485d.DBUtils$1 r38) {
        ...
        L7d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ai.kudi.agent.p036v2.productAllCollectionFields.viewData.ProductAllCollectionFieldsViewData.<init>(ai.kudi.agent.core.domain.data.ProductField, ai.kudi.agent.v2.common.view.viewData.data.Error, boolean, boolean, java.util.List, ai.kudi.agent.v2.common.view.viewData.data.Error, boolean, ai.kudi.agent.v2.common.view.viewData.data.Error, java.util.Map, java.util.List, boolean, ai.kudi.agent.v2.common.view.viewData.data.Error, int, kotlin.e0.d.DBUtils$1):void");
    }

    /* JADX WARN: Can't parse signature for local variable: 
    java.lang.NullPointerException
     */
    public static /* synthetic */ ProductAllCollectionFieldsViewData copy$default(ProductAllCollectionFieldsViewData productAllCollectionFieldsViewData, ProductField $r2, Error $r3, boolean $z0, boolean $z1, List $r4, Error $r5, boolean $z2, Error $r6, Map $r7, List $r8, boolean $z3, Error $r9, int i, Object obj) {
        int $i1 = i & 1;
        if ($i1 != 0) {
            $r2 = productAllCollectionFieldsViewData.productField;
        }
        int $i12 = i & 2;
        if ($i12 != 0) {
            $r3 = productAllCollectionFieldsViewData.error;
        }
        int $i13 = i & 4;
        if ($i13 != 0) {
            $z0 = productAllCollectionFieldsViewData.loading;
        }
        int $i14 = i & 8;
        if ($i14 != 0) {
            $z1 = productAllCollectionFieldsViewData.fetchingLocation;
        }
        int $i15 = i & 16;
        if ($i15 != 0) {
            $r4 = productAllCollectionFieldsViewData.location;
        }
        int $i16 = i & 32;
        if ($i16 != 0) {
            $r5 = productAllCollectionFieldsViewData.locationError;
        }
        int $i17 = i & 64;
        if ($i17 != 0) {
            $z2 = productAllCollectionFieldsViewData.uploadingFile;
        }
        int $i18 = i & 128;
        if ($i18 != 0) {
            $r6 = productAllCollectionFieldsViewData.fileUploadError;
        }
        int $i19 = i & 256;
        if ($i19 != 0) {
            $r7 = productAllCollectionFieldsViewData.filePropertyMap;
        }
        int $i110 = i & IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED;
        if ($i110 != 0) {
            $r8 = productAllCollectionFieldsViewData.associatedFields;
        }
        int $i111 = i & 1024;
        if ($i111 != 0) {
            $z3 = productAllCollectionFieldsViewData.fetchingAssociatedFields;
        }
        int $i0 = i & IjkMediaMeta.FF_PROFILE_H264_INTRA;
        if ($i0 != 0) {
            $r9 = productAllCollectionFieldsViewData.associatedFieldsError;
        }
        ProductAllCollectionFieldsViewData $r0 = productAllCollectionFieldsViewData.copy($r2, $r3, $z0, $z1, $r4, $r5, $z2, $r6, $r7, $r8, $z3, $r9);
        return $r0;
    }
    ...
    java.lang.NullPointerException
     */
    public final ProductAllCollectionFieldsViewData copy(ProductField productField, Error error, boolean z, boolean z2, List list, Error error2, boolean z3, Error error3, Map map, List list2, boolean z4, Error error4) {
        Log_OC.getArray(list, "location");
        Log_OC.getArray(map, "filePropertyMap");
        Log_OC.getArray(list2, "associatedFields");
        ProductAllCollectionFieldsViewData $r0 = new ProductAllCollectionFieldsViewData(productField, error, z, z2, list, error2, z3, error3, map, list2, z4, error4);
        return $r0;
    }
    ...
    public boolean equals(Object obj) {
        ...
        boolean $z0 = obj instanceof ProductAllCollectionFieldsViewData;
        if ($z0) {
            ProductAllCollectionFieldsViewData $r2 = (ProductAllCollectionFieldsViewData) obj;
    ...
    public String toString() {
        ...
        $r2.append("ProductAllCollectionFieldsViewData(productField=");
        ProductField $r3 = this.productField;
        $r2.append($r3);
        $r2.append(", error=");
        Error $r4 = this.error;
