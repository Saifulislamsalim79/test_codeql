...
/* renamed from: ai.kudi.agent.v2.productLookup.fragment.ProductLookupFragment$special$$inlined$activityViewModels$default$1 */
/* loaded from: classes.dex */
public final class C0725xa43b2a0f extends AbstractC11802m implements InterfaceC11756a<C1566i0> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0725xa43b2a0f(Fragment fragment) {
        super(0);
