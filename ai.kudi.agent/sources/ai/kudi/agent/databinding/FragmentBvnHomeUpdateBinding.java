...
public final class FragmentBvnHomeUpdateBinding implements InterfaceC8209a {
    ...
    private FragmentBvnHomeUpdateBinding(ConstraintLayout constraintLayout, AppBarLayout appBarLayout, ImageView imageView, KudiInputField kudiInputField, TextView textView, ScrollView scrollView, TextView textView2, Toolbar toolbar, TextView textView3, KudiButton kudiButton) {
     ...
     */
    public static FragmentBvnHomeUpdateBinding bind(View view) {
                                ...
                                if ($r8 != null) {
                                    ...
                                    if ($r9 != null) {
                                        ...
                                        if ($r10 != null) {
                                            ...
                                            FragmentBvnHomeUpdateBinding $r11 = new FragmentBvnHomeUpdateBinding($r122, $r2, imageView, kudiInputField, textView, scrollView, textView2, $r8, $r9, $r10);
                                            return $r11;
                                        }
                                    }
                                }
    ...
    java.lang.NullPointerException
     */
    public static FragmentBvnHomeUpdateBinding inflate(LayoutInflater layoutInflater) {
        FragmentBvnHomeUpdateBinding $r0 = inflate(layoutInflater, null, false);
        return $r0;
    }
    ...
    java.lang.NullPointerException
     */
    public static FragmentBvnHomeUpdateBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View $r2 = layoutInflater.inflate(C0001R.C0004layout.fragment_bvn_home_update, viewGroup, false);
        if (z) {
            viewGroup.addView($r2);
        }
        FragmentBvnHomeUpdateBinding $r3 = bind($r2);
        return $r3;
    }
