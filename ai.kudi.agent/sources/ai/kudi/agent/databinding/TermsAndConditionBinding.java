...
public final class TermsAndConditionBinding implements InterfaceC8209a {
    public final CheckBox acceptCheckBox;
    private final ScrollView rootView;
    public final TextView terms;

    private TermsAndConditionBinding(ScrollView scrollView, CheckBox checkBox, TextView textView) {
    ...
    public static TermsAndConditionBinding bind(View view) {
        int $i0 = C0001R.C0003id.acceptCheckBox;
        View $r1 = view.findViewById(C0001R.C0003id.acceptCheckBox);
        CheckBox $r2 = (CheckBox) $r1;
        if ($r2 != null) {
            $i0 = C0001R.C0003id.terms;
            View $r12 = view.findViewById(C0001R.C0003id.terms);
            TextView $r3 = (TextView) $r12;
            if ($r3 != null) {
                ScrollView $r5 = (ScrollView) view;
                TermsAndConditionBinding $r4 = new TermsAndConditionBinding($r5, $r2, $r3);
                return $r4;
            }
        }
    ...
    public static TermsAndConditionBinding inflate(LayoutInflater layoutInflater) {
        TermsAndConditionBinding $r0 = inflate(layoutInflater, null, false);
        return $r0;
    }
    ...
    public static TermsAndConditionBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View $r2 = layoutInflater.inflate(C0001R.C0004layout.terms_and_condition, viewGroup, false);
        if (z) {
            viewGroup.addView($r2);
        }
        TermsAndConditionBinding $r3 = bind($r2);
        return $r3;
    }
