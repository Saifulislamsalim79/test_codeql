...
public final class FragmentIncompleteTransactionsBinding implements InterfaceC8209a {
    ...
    private FragmentIncompleteTransactionsBinding(ConstraintLayout constraintLayout, EmptyHistoryBinding emptyHistoryBinding, AppCompatTextView appCompatTextView, TextView textView, FrameLayout frameLayout, RecyclerView recyclerView) {
     ...
     */
    public static FragmentIncompleteTransactionsBinding bind(View view) {
                ...
                if ($r4 != null) {
                    ...
                    if (frameLayout != null) {
                        ...
                        if (recyclerView != null) {
                            FragmentIncompleteTransactionsBinding $r7 = new FragmentIncompleteTransactionsBinding((ConstraintLayout) view, $r2, $r3, $r4, frameLayout, recyclerView);
                            return $r7;
                        }
                    }
                }
    ...
    java.lang.NullPointerException
     */
    public static FragmentIncompleteTransactionsBinding inflate(LayoutInflater layoutInflater) {
        FragmentIncompleteTransactionsBinding $r0 = inflate(layoutInflater, null, false);
        return $r0;
    }
    ...
    java.lang.NullPointerException
     */
    public static FragmentIncompleteTransactionsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View $r2 = layoutInflater.inflate(C0001R.C0004layout.fragment_incomplete_transactions, viewGroup, false);
        if (z) {
            viewGroup.addView($r2);
        }
        FragmentIncompleteTransactionsBinding $r3 = bind($r2);
        return $r3;
    }
