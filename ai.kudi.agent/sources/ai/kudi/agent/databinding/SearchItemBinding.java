...
public final class SearchItemBinding implements InterfaceC8209a {
    public final TextView bankNameText;
    public final View divider;
    private final LinearLayout rootView;
    public final ImageView selectedImage;

    private SearchItemBinding(LinearLayout linearLayout, TextView textView, View view, ImageView imageView) {
    ...
    public static SearchItemBinding bind(View view) {
        int $i0 = C0001R.C0003id.bank_name_text;
        TextView $r2 = (TextView) view.findViewById(C0001R.C0003id.bank_name_text);
        if ($r2 != null) {
            $i0 = C0001R.C0003id.divider;
            View $r1 = view.findViewById(C0001R.C0003id.divider);
            if ($r1 != null) {
                $i0 = C0001R.C0003id.selectedImage;
                View $r3 = view.findViewById(C0001R.C0003id.selectedImage);
                ImageView $r4 = (ImageView) $r3;
                if ($r4 != null) {
                    LinearLayout $r6 = (LinearLayout) view;
                    SearchItemBinding $r5 = new SearchItemBinding($r6, $r2, $r1, $r4);
                    return $r5;
                }
            }
        }
    ...
    public static SearchItemBinding inflate(LayoutInflater layoutInflater) {
        SearchItemBinding $r0 = inflate(layoutInflater, null, false);
        return $r0;
    }
    ...
    public static SearchItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View $r2 = layoutInflater.inflate(C0001R.C0004layout.search_item, viewGroup, false);
        if (z) {
            viewGroup.addView($r2);
        }
        SearchItemBinding $r3 = bind($r2);
        return $r3;
    }
