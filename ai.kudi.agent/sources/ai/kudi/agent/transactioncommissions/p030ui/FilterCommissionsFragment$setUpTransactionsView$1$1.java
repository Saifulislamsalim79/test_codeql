...
/* renamed from: ai.kudi.agent.transactioncommissions.ui.FilterCommissionsFragment$setUpTransactionsView$1$1 */
/* loaded from: classes.dex */
final class FilterCommissionsFragment$setUpTransactionsView$1$1 extends AbstractC11802m implements InterfaceC11767l<TransactionItemUiModel.Transaction, C13666w> {
    final /* synthetic */ FilterCommissionsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FilterCommissionsFragment$setUpTransactionsView$1$1(FilterCommissionsFragment filterCommissionsFragment) {
        super(1);
    ...
    public final void invoke2(TransactionItemUiModel.Transaction transaction) {
        ...
        FilterCommissionsViewModel $r2 = $r3.getViewModel();
