...
public class RequestCommissionsCashoutUseCase implements OneInputUseCase<CommissionCashoutResponse, CommissionCashoutRequest> {
    ...
    public static final InterfaceC11692s m40951execute$lambda1(RequestCommissionsCashoutUseCase requestCommissionsCashoutUseCase, CommissionCashoutRequest commissionCashoutRequest, User user) {
        Log_OC.getArray(requestCommissionsCashoutUseCase, "this$0");
        Log_OC.getArray(commissionCashoutRequest, "$input");
        Log_OC.getArray(user, "user");
        NetworkService $r3 = requestCommissionsCashoutUseCase.networkService;
        AddNoteCommand $r4 = $r3.getApi();
        String $r5 = user.getSessionId();
        Log_OC.loadImage($r5, "user.sessionId");
        AbstractC11688p $r6 = $r4.requestCommissionsCashout(commissionCashoutRequest, $r5);
        C0566c $r7 = C0566c.f1529d;
    ...
    public static final CommissionCashoutResponse m40952execute$lambda1$lambda0(APIResponse aPIResponse) {
        Log_OC.getArray(aPIResponse, "response");
        Object $r1 = aPIResponse.data;
        CommissionCashoutResponse $r2 = (CommissionCashoutResponse) $r1;
        return $r2;
    }
    ...
    java.lang.NullPointerException
     */
    public AbstractC11688p execute(final CommissionCashoutRequest commissionCashoutRequest) {
        Log_OC.getArray(commissionCashoutRequest, MetricTracker.Object.INPUT);
        UserRepository $r3 = this.userRepo;
        AbstractC11696w $r4 = $r3.getCurrentUser();
        AbstractC11688p $r5 = $r4.m10440j(new InterfaceC11291f() { // from class: ai.kudi.agent.transactioncommissions.domain.Item
            /* JADX WARN: Can't parse signature for local variable: 
            java.lang.NullPointerException
             */
            ...
            public final Object mo10663a(Object obj) {
                RequestCommissionsCashoutUseCase $r1 = RequestCommissionsCashoutUseCase.this;
                CommissionCashoutRequest $r2 = commissionCashoutRequest;
                User $r52 = (User) obj;
                InterfaceC11692s $r32 = RequestCommissionsCashoutUseCase.m40951execute$lambda1($r1, $r2, $r52);
                return $r32;
            }
        });
    ...
    public /* bridge */ /* synthetic */ AbstractC11688p execute(Object obj) {
        CommissionCashoutRequest $r3 = (CommissionCashoutRequest) obj;
