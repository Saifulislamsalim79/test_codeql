...
public final class SubmitWithdrawalRequest implements OneInputUseCase<WithdrawalResponse, WithdrawalRequest> {
    ...
    public static final InterfaceC11692s m39040execute$lambda0(SubmitWithdrawalRequest submitWithdrawalRequest, ai.kudi.agent.withdrawal.domain.wiki.WithdrawalRequest withdrawalRequest, User user) {
        Log_OC.getArray(submitWithdrawalRequest, "this$0");
        Log_OC.getArray(withdrawalRequest, "$request");
        Log_OC.getArray(user, "it");
        NetworkService $r3 = submitWithdrawalRequest.networkService;
        AddNoteCommand $r4 = $r3.getApi();
        String $r5 = user.getSessionId();
        Log_OC.loadImage($r5, "it.sessionId");
        AbstractC11688p $r6 = $r4.postWithdrawal($r5, withdrawalRequest);
        return $r6;
    }
    ...
    public AbstractC11688p execute(final ai.kudi.agent.withdrawal.domain.wiki.WithdrawalRequest withdrawalRequest) {
        ...
        AbstractC11688p $r5 = $r4.m10440j(new InterfaceC11291f() { // from class: ai.kudi.agent.bills.domain.usecases.j
            /* JADX WARN: Can't parse signature for local variable: 
            java.lang.NullPointerException
             */
            ...
            public final Object mo10663a(Object obj) {
                SubmitWithdrawalRequest $r1 = SubmitWithdrawalRequest.this;
                ai.kudi.agent.withdrawal.domain.wiki.WithdrawalRequest $r2 = withdrawalRequest;
                User $r52 = (User) obj;
                InterfaceC11692s $r32 = SubmitWithdrawalRequest.m39040execute$lambda0($r1, $r2, $r52);
                return $r32;
            }
        });
