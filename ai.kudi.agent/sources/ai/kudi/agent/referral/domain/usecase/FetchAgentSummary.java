...
@Metadata(m10422d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u000f\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u001c\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u00062\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\tR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m10421d2 = {"Lai/kudi/agent/referral/domain/usecase/FetchAgentSummary;", "", "networkService", "Lai/kudi/agent/core/network/NetworkService;", "(Lai/kudi/agent/core/network/NetworkService;)V", "execute", "Lio/reactivex/Observable;", "Lai/kudi/agent/referral/AgentReferralSummary;", "sessionId", "", "referralId", "app_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
/* loaded from: classes.dex */
public final class FetchAgentSummary {
    private final NetworkService networkService;

    public FetchAgentSummary(NetworkService networkService) {
    ...
    public static final AgentReferralSummary m40245execute$lambda0(APIResponse aPIResponse) {
        Log_OC.getArray(aPIResponse, "it");
        Object $r1 = aPIResponse.data;
        AgentReferralSummary $r2 = (AgentReferralSummary) $r1;
        return $r2;
    }
    ...
    public final AbstractC11688p execute(String str, String str2) {
        ...
        AbstractC11688p $r5 = $r4.getSummary(str, str2);
        ClassWriter $r6 = ClassWriter.f956b;
        ...
        Log_OC.loadImage($r54, "networkService.referralApi.getSummary(sessionId, referralId).map {\n            it.data\n        }.subscribeOn(Schedulers.io())\n                .observeOn(AndroidSchedulers.mainThread())");
        return $r54;
    }
}
