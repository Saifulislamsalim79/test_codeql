...
public final class CreateAgentReferral {
    ...
    public static final AgentReferralModel m40241execute$lambda0(APIResponse aPIResponse) {
    ...
    java.lang.NullPointerException
     */
    public final AbstractC11688p execute(String str, AgentReferralModel agentReferralModel) {
        ...
        AbstractC11688p $r5 = $r4.createReferral(str, agentReferralModel);
        ...
        Log_OC.loadImage($r54, "networkService.referralApi.createReferral(sessionId, agentReferralModel)\n                .map { it.data }\n                .subscribeOn(Schedulers.io())\n                .observeOn(AndroidSchedulers.mainThread())");
        return $r54;
    }
}
