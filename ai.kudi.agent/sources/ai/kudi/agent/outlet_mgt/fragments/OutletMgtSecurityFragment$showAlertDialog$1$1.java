...
public final class OutletMgtSecurityFragment$showAlertDialog$1$1 extends AbstractC11802m implements InterfaceC11756a<C13666w> {
    final /* synthetic */ DialogInterfaceC0936d $alertDialog;
    final /* synthetic */ OutletMgtSecurityFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OutletMgtSecurityFragment$showAlertDialog$1$1(OutletMgtSecurityFragment outletMgtSecurityFragment, DialogInterfaceC0936d dialogInterfaceC0936d) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if ($r2 != null) {
            ContextExtKt.toast$default($r2, "Outlet Suspended", 0, 2, (Object) null);
        }
        OutletMgtSecurityFragment $r12 = this.this$0;
        STATUS $r3 = STATUS.SUSPENDED;
        String $r4 = $r3.name();
