...
/* compiled from: CreateOutlet.kt */
@Metadata(m10422d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\u0018\u00002\u00020\u0001B\u000f\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u001c\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u00062\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, m10421d2 = {"Lai/kudi/agent/outlet_mgt/useCases/CreateOutlet;", "", "networkService", "Lai/kudi/agent/core/network/NetworkService;", "(Lai/kudi/agent/core/network/NetworkService;)V", "execute", "Lio/reactivex/Observable;", "Lai/kudi/agent/settings/domain/dto/UserProfileResponse;", "createOutletRequest", "Lai/kudi/agent/outlet_mgt/data/CreateOutletRequest;", "sessionId", "", "app_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
/* loaded from: classes.dex */
public final class CreateOutlet {
    private final NetworkService networkService;

    public CreateOutlet(NetworkService networkService) {
    ...
    public static final UserProfileResponse m39898execute$lambda0(APIResponse aPIResponse) {
        Log_OC.getArray(aPIResponse, "it");
        Object $r1 = aPIResponse.data;
        UserProfileResponse $r2 = (UserProfileResponse) $r1;
        return $r2;
    }
    ...
    java.lang.NullPointerException
     */
    public final AbstractC11688p execute(CreateOutletRequest createOutletRequest, String str) {
        ...
        AbstractC11688p $r5 = $r4.createOutlet(str, createOutletRequest);
        ...
        Log_OC.loadImage($r54, "networkService.outletApi.createOutlet(sessionId, createOutletRequest)\n                .map {\n                    it.data\n                }.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())");
        return $r54;
    }
}
