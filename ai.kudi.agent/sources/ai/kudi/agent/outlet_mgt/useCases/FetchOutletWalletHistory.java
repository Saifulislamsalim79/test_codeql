...
/* compiled from: FetchOutletWalletHistory.kt */
@Metadata(m10422d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u000f\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u001a\u0010\u0007\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\b2\u0006\u0010\u000b\u001a\u00020\fR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\r"}, m10421d2 = {"Lai/kudi/agent/outlet_mgt/useCases/FetchOutletWalletHistory;", "", "repository", "Lai/kudi/agent/transactionhistory/data/repository/TransactionsRepository;", "(Lai/kudi/agent/transactionhistory/data/repository/TransactionsRepository;)V", "getRepository", "()Lai/kudi/agent/transactionhistory/data/repository/TransactionsRepository;", "execute", "Lio/reactivex/Observable;", "", "Lai/kudi/agent/transactionhistory/data/model/TransactionDataModel;", TransactionRequest.TYPE_REQUEST, "Lai/kudi/agent/transactionhistory/data/source/request/GetOutletWalletActivitiesRequest;", "app_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
/* loaded from: classes.dex */
public final class FetchOutletWalletHistory {
    private final TransactionsRepository repository;

    public FetchOutletWalletHistory(TransactionsRepository transactionsRepository) {
    ...
    public final AbstractC11688p execute(GetOutletWalletActivitiesRequest getOutletWalletActivitiesRequest) {
        ...
        AbstractC11688p $r3 = $r2.outletWalletActivities(getOutletWalletActivitiesRequest);
        ...
        Log_OC.loadImage($r33, "repository.outletWalletActivities(request)\n            .subscribeOn(Schedulers.io())\n            .observeOn(AndroidSchedulers.mainThread())");
        return $r33;
    }
