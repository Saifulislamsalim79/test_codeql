...
public final class ShortTextInputFieldView extends FormInputFieldView {
    ...
    public ShortTextInputFieldView(Context context) {
        this(context, null, 0, 6, null);
        Log_OC.getArray(context, "context");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public ShortTextInputFieldView(Context context, AttributeSet attributeSet) {
     ...
     */
    public ShortTextInputFieldView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        InterfaceC11824h $r4;
        InterfaceC11824h $r42;
        Log_OC.getArray(context, "context");
        ShortTextInputFieldView$normalStateBackground$2 $r3 = new ShortTextInputFieldView$normalStateBackground$2(context);
        $r4 = C13218k.m5625b($r3);
        this.normalStateBackground$delegate = $r4;
        ShortTextInputFieldView$errorStateBackground$2 $r5 = new ShortTextInputFieldView$errorStateBackground$2(context);
    ...
    */
    public /* synthetic */ ShortTextInputFieldView(android.content.Context r2, android.util.AttributeSet r3, int r4, int r5, kotlin.p483e0.p485d.DBUtils$1 r6) {
        /*
            r1 = this;
            r0 = r5 & 2
            if (r0 == 0) goto L5
        ...
        La:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ai.kudi.agent.merchantProduct.forms.ShortTextInputFieldView.<init>(android.content.Context, android.util.AttributeSet, int, int, kotlin.e0.d.DBUtils$1):void");
    }
    ...
    public int layoutResource() {
        int i0 = R$layout.view_short_text_input_field;
        return i0;
    }
    ...
    */
    public void setError(java.lang.String r7) {
        ...
        L3a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ai.kudi.agent.merchantProduct.forms.ShortTextInputFieldView.setError(java.lang.String):void");
    }
}
