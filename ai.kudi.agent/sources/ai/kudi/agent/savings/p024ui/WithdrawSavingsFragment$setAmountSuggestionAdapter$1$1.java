...
/* renamed from: ai.kudi.agent.savings.ui.WithdrawSavingsFragment$setAmountSuggestionAdapter$1$1 */
/* loaded from: classes.dex */
final class WithdrawSavingsFragment$setAmountSuggestionAdapter$1$1 extends AbstractC11802m implements InterfaceC11772q<Long, View, Integer, C13666w> {
    final /* synthetic */ FragmentWithdrawSavingsBinding $this_apply;
    final /* synthetic */ WithdrawSavingsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WithdrawSavingsFragment$setAmountSuggestionAdapter$1$1(FragmentWithdrawSavingsBinding fragmentWithdrawSavingsBinding, WithdrawSavingsFragment withdrawSavingsFragment) {
        super(3);
        this.$this_apply = fragmentWithdrawSavingsBinding;
        this.this$0 = withdrawSavingsFragment;
    }
    ...
    public final void invoke(long j, View view, int i) {
        ...
        FragmentWithdrawSavingsBinding $r3 = this.$this_apply;
        TextView $r4 = $r3.amountEditText;
        C11780a0 c11780a0 = C11780a0.f26475a;
        WithdrawSavingsFragment $r6 = this.this$0;
        int $i1 = C0456R.string.total_amount_processed;
