...
/* renamed from: ai.kudi.agent.transactionhistory.ui.widget.TransactionsView$onTransactionItemClicked$1 */
/* loaded from: classes.dex */
final class TransactionsView$onTransactionItemClicked$1 extends AbstractC11802m implements InterfaceC11767l<TransactionItemUiModel.Transaction, C13666w> {
    public static final TransactionsView$onTransactionItemClicked$1 INSTANCE;

    /* JADX WARN: Can't parse signature for local variable: 
    java.lang.NullPointerException
     */
    static {
        TransactionsView$onTransactionItemClicked$1 $r0 = new TransactionsView$onTransactionItemClicked$1();
        INSTANCE = $r0;
    }

    TransactionsView$onTransactionItemClicked$1() {
        super(1);
    }
