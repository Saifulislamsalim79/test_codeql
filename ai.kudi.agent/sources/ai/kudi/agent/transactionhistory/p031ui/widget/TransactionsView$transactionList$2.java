...
/* renamed from: ai.kudi.agent.transactionhistory.ui.widget.TransactionsView$transactionList$2 */
/* loaded from: classes.dex */
public final class TransactionsView$transactionList$2 extends AbstractC11802m implements InterfaceC11756a<RecyclerView> {
    final /* synthetic */ TransactionsView this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TransactionsView$transactionList$2(TransactionsView transactionsView) {
        super(0);
    ...
    public final RecyclerView invoke() {
        ...
        FrameLayout r4 = $r2;
        View $r1 = r4.findViewById(C0001R.C0003id.transaction_list);
