...
/* renamed from: ai.kudi.agent.transactionhistory.ui.view.FilterTransactionsFragment$setUpTransactionsView$1$1 */
/* loaded from: classes.dex */
public final class FilterTransactionsFragment$setUpTransactionsView$1$1 extends AbstractC11802m implements InterfaceC11767l<TransactionItemUiModel.Transaction, C13666w> {
    final /* synthetic */ FilterTransactionsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FilterTransactionsFragment$setUpTransactionsView$1$1(FilterTransactionsFragment filterTransactionsFragment) {
        super(1);
    ...
    public final void invoke2(TransactionItemUiModel.Transaction transaction) {
        ...
        FilterTransactionsFragment $r3 = this.this$0;
        Context $r4 = $r3.getContext();
        Intent $r2 = new Intent($r4, TransactionDetailsActivity.class);
        String $r5 = transaction.getId();
        $r2.putExtra("transaction_details_extra_reference", $r5);
        FilterTransactionsFragment $r32 = this.this$0;
