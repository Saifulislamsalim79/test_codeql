...
/* compiled from: FetchWalletActivities.kt */
@Metadata(m10422d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0016\u0018\u00002\u00020\u0001B\u0017\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u001a\u0010\u0007\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\b2\u0006\u0010\u000b\u001a\u00020\fR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, m10421d2 = {"Lai/kudi/agent/transactionhistory/domain/usecases/FetchWalletActivities;", "", "repository", "Lai/kudi/agent/transactionhistory/data/repository/TransactionsRepository;", "rxSchedulers", "Lai/kudi/agent/core/schedulers/RxSchedulers;", "(Lai/kudi/agent/transactionhistory/data/repository/TransactionsRepository;Lai/kudi/agent/core/schedulers/RxSchedulers;)V", "execute", "Lio/reactivex/Observable;", "", "Lai/kudi/agent/transactionhistory/data/model/TransactionDataModel;", MetricTracker.Object.INPUT, "Lai/kudi/agent/transactionhistory/data/source/request/GetWalletActivitiesRequest;", "app_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
/* loaded from: classes.dex */
public class FetchWalletActivities {
    private final TransactionsRepository repository;
    private final RxSchedulers rxSchedulers;

    public FetchWalletActivities(TransactionsRepository transactionsRepository, RxSchedulers rxSchedulers) {
    ...
    public final AbstractC11688p execute(GetWalletActivitiesRequest getWalletActivitiesRequest) {
        ...
        AbstractC11688p $r3 = $r2.walletActivities(getWalletActivitiesRequest);
        ...
        Log_OC.loadImage($r33, "repository.walletActivities(input)\n            .subscribeOn(rxSchedulers.io())\n            .observeOn(rxSchedulers.main())");
        return $r33;
    }
}
