...
public final class CheckIfBvnExists implements OneInputUseCase<Boolean, String> {
    ...
    public static final Boolean m40333execute$lambda0(APIResponse aPIResponse) {
        Log_OC.getArray(aPIResponse, "it");
        Object $r1 = aPIResponse.data;
        Boolean $r2 = (Boolean) $r1;
        return $r2;
    }
    ...
    public AbstractC11688p execute(String str) {
        ...
        AbstractC11688p $r4 = $r3.checkBvnExistence(str);
        Filter $r5 = Filter.next;
        ...
        Log_OC.loadImage($r44, "networkService.onboardingApi.checkBvnExistence(input).map {\n            it.data\n        }.subscribeOn(rxSchedulers.io()).observeOn(rxSchedulers.main())");
        return $r44;
    }
}
