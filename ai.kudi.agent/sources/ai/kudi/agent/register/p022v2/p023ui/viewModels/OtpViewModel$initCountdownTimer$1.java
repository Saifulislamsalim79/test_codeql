...
/* renamed from: ai.kudi.agent.register.v2.ui.viewModels.OtpViewModel$initCountdownTimer$1 */
/* loaded from: classes.dex */
public final class OtpViewModel$initCountdownTimer$1 extends AbstractC11802m implements InterfaceC11767l<Long, C13666w> {
    final /* synthetic */ OtpViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OtpViewModel$initCountdownTimer$1(OtpViewModel otpViewModel) {
        super(1);
    ...
    public final void invoke(long j) {
        OtpViewModel $r1 = this.this$0;
        OtpViewData $r2 = OtpViewModel.access$getState($r1);
        String $r3 = RandomUtilKt.toMinute_Second(j);
        $r1.publish($r2.copy($r3));
    }
}
