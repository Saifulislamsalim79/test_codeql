package ai.kudi.agent.banks.p001ui.adapter;

import ai.kudi.agent.core.C0038R;
import ai.kudi.agent.core.databinding.ListItemBanksBinding;
...
@Metadata(m10422d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003:\u0002\u0019\u001aB3\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00028\u00000\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00028\u00000\t\u0012\b\u0010\n\u001a\u0004\u0018\u00010\u000b¢\u0006\u0002\u0010\fJ\b\u0010\r\u001a\u00020\u000eH\u0016J\u0018\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u000eH\u0016J\"\u0010\u0014\u001a\f0\u0015R\b\u0012\u0004\u0012\u00028\u00000\u00002\u0006\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u000eH\u0016R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00028\u00000\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\n\u001a\u0004\u0018\u00010\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00028\u00000\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001b"}, m10421d2 = {"Lai/kudi/agent/banks/ui/adapter/BanksAdapter;", "T", "Lai/kudi/agent/register/adapter/DynamicSearchAdapter$Searchable;", "Lai/kudi/agent/register/adapter/DynamicSearchAdapter;", "context", "Landroid/content/Context;", "mutableList", "", "bankAdapterClickListener", "Lai/kudi/agent/banks/ui/adapter/BanksAdapter$BankAdapterClickListener;", "bankCode", "", "(Landroid/content/Context;Ljava/util/List;Lai/kudi/agent/banks/ui/adapter/BanksAdapter$BankAdapterClickListener;Ljava/lang/String;)V", "getItemCount", "", "onBindViewHolder", "", "holder", "Lai/kudi/agent/register/adapter/BaseViewHolder;", "position", "onCreateViewHolder", "Lai/kudi/agent/banks/ui/adapter/BanksAdapter$SearchViewHolder;", "parent", "Landroid/view/ViewGroup;", "viewType", "BankAdapterClickListener", "SearchViewHolder", "core_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
/* renamed from: ai.kudi.agent.banks.ui.adapter.BanksAdapter */
...
public final class BanksAdapter<T extends DynamicSearchAdapter.Searchable> extends DynamicSearchAdapter<T> {
    ...
    /* compiled from: BanksAdapter.kt */
    @Metadata(m10422d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\bf\u0018\u0000*\u0004\b\u0001\u0010\u00012\u00020\u0002J\u0015\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00028\u0001H&¢\u0006\u0002\u0010\u0006¨\u0006\u0007"}, m10421d2 = {"Lai/kudi/agent/banks/ui/adapter/BanksAdapter$BankAdapterClickListener;", "T", "", "onBankSelected", "", "bank", "(Ljava/lang/Object;)V", "core_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
    /* renamed from: ai.kudi.agent.banks.ui.adapter.BanksAdapter$BankAdapterClickListener */
    /* loaded from: classes.dex */
    ...
    /* compiled from: BanksAdapter.kt */
    @Metadata(m10422d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0006\u0010\u0005\u001a\u00020\u0003R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m10421d2 = {"Lai/kudi/agent/banks/ui/adapter/BanksAdapter$SearchViewHolder;", "Lai/kudi/agent/register/adapter/BaseViewHolder;", "binding", "Lai/kudi/agent/core/databinding/ListItemBanksBinding;", "(Lai/kudi/agent/banks/ui/adapter/BanksAdapter;Lai/kudi/agent/core/databinding/ListItemBanksBinding;)V", "getBinding", "core_release"}, k = 1, m10420mv = {1, 5, 1}, xi = 48)
    /* renamed from: ai.kudi.agent.banks.ui.adapter.BanksAdapter$SearchViewHolder */
    /* loaded from: classes.dex */
    public final class SearchViewHolder extends BaseViewHolder {
        ...
        */
        public SearchViewHolder(ai.kudi.agent.banks.p001ui.adapter.BanksAdapter r4, ai.kudi.agent.core.databinding.ListItemBanksBinding r5) {
            /*
                r3 = this;
                ...
                r3.binding = r5
                android.widget.LinearLayout r1 = r5.getRoot()
                ai.kudi.agent.banks.ui.adapter.BanksAdapter<T extends ai.kudi.agent.register.adapter.DynamicSearchAdapter$Searchable> r4 = r3.this$0
                ai.kudi.agent.banks.ui.adapter.d r2 = new ai.kudi.agent.banks.ui.adapter.d
                r2.<init>()
                r1.setOnClickListener(r2)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ai.kudi.agent.banks.p001ui.adapter.BanksAdapter.SearchViewHolder.<init>(ai.kudi.agent.banks.ui.adapter.BanksAdapter, ai.kudi.agent.core.databinding.ListItemBanksBinding):void");
        }
        ...
        public static final void m39014_init_$lambda0(BanksAdapter banksAdapter, SearchViewHolder searchViewHolder, View view) {
        ...
        java.lang.NullPointerException
         */
        public final ListItemBanksBinding getBinding() {
            ListItemBanksBinding r1 = this.binding;
            return r1;
        }
    }
    ...
    public void onBindViewHolder2(BaseViewHolder baseViewHolder, int i) {
        ...
        if ($z0) {
            ...
            ListItemBanksBinding $r3 = $r2.getBinding();
            ...
            String $r8 = $r7 == null ? null : $r7.getSearchCriteria();
            $r4.setText($r8);
            ...
            int $i0 = C0038R.C0039drawable.ic_selected;
            Drawable $r12 = C1335a.m36322f($r11, $i0);
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        ListItemBanksBinding $r5 = ListItemBanksBinding.inflate($r4, viewGroup, false);
    ...
    public /* bridge */ /* synthetic */ BaseViewHolder onCreateViewHolder2(ViewGroup viewGroup, int i) {
