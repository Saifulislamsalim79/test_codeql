...
public final class NotificationAdapter$onBindViewHolder$1 extends AbstractC11802m implements InterfaceC11767l<View, C13666w> {
    final /* synthetic */ int $position;
    final /* synthetic */ NotificationAdapter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationAdapter$onBindViewHolder$1(NotificationAdapter notificationAdapter, int i) {
        super(1);
    ...
    public final void invoke2(View view) {
        ...
        NotificationAdapter $r2 = this.this$0;
        InterfaceC11772q $r3 = $r2.getOnClickListener();
        if ($r3 == null) {
            return;
        }
        NotificationAdapter $r22 = this.this$0;
        List $r4 = $r22.notifications;
        Log_OC.append($r4);
