...
public final class SubmitTransactionRequest implements OneInputUseCase<TransactionResponse, TransactionRequest> {
    ...
    public SubmitTransactionRequest(NetworkService networkService, UserRepository userRepository) {
    ...
    public static final InterfaceC11692s m41119execute$lambda0(SubmitTransactionRequest submitTransactionRequest, TransactionRequest transactionRequest, User user) {
        Log_OC.getArray(submitTransactionRequest, "this$0");
        Log_OC.getArray(transactionRequest, "$request");
        Log_OC.getArray(user, "it");
        NetworkService $r3 = submitTransactionRequest.networkService;
        AddNoteCommand $r4 = $r3.getApi();
        String $r5 = user.getSessionId();
        Log_OC.loadImage($r5, "it.sessionId");
        AbstractC11688p $r6 = $r4.postTransaction($r5, transactionRequest);
        return $r6;
    }
    ...
    public AbstractC11688p execute(final TransactionRequest transactionRequest) {
        ...
        AbstractC11688p $r5 = $r4.m10440j(new InterfaceC11291f() { // from class: ai.kudi.agent.transactions.domain.usecases.a
            /* JADX WARN: Can't parse signature for local variable: 
            java.lang.NullPointerException
             */
            ...
            public final Object mo10663a(Object obj) {
                ...
                User $r52 = (User) obj;
                InterfaceC11692s $r32 = SubmitTransactionRequest.m41119execute$lambda0($r1, $r2, $r52);
                return $r32;
            }
        });
        ...
        Log_OC.loadImage($r53, "userRepo.currentUser\n                .flatMapObservable { networkService.api.postTransaction(it.sessionId, request) }\n                .subscribeOn(Schedulers.io())\n                .observeOn(AndroidSchedulers.mainThread())");
        return $r53;
    }
