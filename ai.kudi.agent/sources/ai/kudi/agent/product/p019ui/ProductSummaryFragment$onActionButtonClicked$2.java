...
/* renamed from: ai.kudi.agent.product.ui.ProductSummaryFragment$onActionButtonClicked$2 */
/* loaded from: classes.dex */
final class ProductSummaryFragment$onActionButtonClicked$2 extends AbstractC11802m implements InterfaceC11767l<Bundle, C13666w> {
    final /* synthetic */ String $transactionReference;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProductSummaryFragment$onActionButtonClicked$2(String str) {
        super(1);
