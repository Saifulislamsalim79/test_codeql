...
/* renamed from: ai.kudi.agent.product.other_bills.ui.PayBillsFragment$loadBillers$1$adapter$1 */
/* loaded from: classes.dex */
public final class PayBillsFragment$loadBillers$1$adapter$1 extends AbstractC11802m implements InterfaceC11767l<Biller, C13666w> {
    final /* synthetic */ PayBillsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PayBillsFragment$loadBillers$1$adapter$1(PayBillsFragment payBillsFragment) {
        super(1);
