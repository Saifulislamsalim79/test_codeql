...
/* renamed from: ai.kudi.agent.product.other_bills.ui.AmountFragment$setAmountSuggestionAdapter$1$1 */
/* loaded from: classes.dex */
final class AmountFragment$setAmountSuggestionAdapter$1$1 extends AbstractC11802m implements InterfaceC11772q<Long, View, Integer, C13666w> {
    final /* synthetic */ FragmentAmountBinding $this_apply;
    final /* synthetic */ AmountFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AmountFragment$setAmountSuggestionAdapter$1$1(FragmentAmountBinding fragmentAmountBinding, AmountFragment amountFragment) {
        super(3);
        this.$this_apply = fragmentAmountBinding;
    ...
    public final void invoke(long j, View view, int i) {
        ...
        FragmentAmountBinding $r3 = this.$this_apply;
