...
final class BillerRepositoryImpl$fetchFrequentlyUsedBillers$1 extends AbstractC11802m implements InterfaceC11767l<List<? extends Biller>, C13666w> {
    final /* synthetic */ BillerRepositoryImpl this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BillerRepositoryImpl$fetchFrequentlyUsedBillers$1(BillerRepositoryImpl billerRepositoryImpl) {
        super(1);
    ...
    public static final void m40227invoke$lambda0(List list) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: invoke$lambda-1  reason: not valid java name */
    public static final void m40228invoke$lambda1(Throwable th) {
        th.printStackTrace();
    ...
    public final void invoke2(List list) {
        ...
        AbstractC11696w $r5 = $r4.saveBillers(list);
        Item $r6 = ClassWriter.LogError();
        AbstractC11696w $r52 = $r5.u($r6);
        ChildNumber $r7 = ChildNumber.ONE;
        ComponentFactory $r1 = ComponentFactory.instance;
        $r52.s($r7, $r1);
    }
}
