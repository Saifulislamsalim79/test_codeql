...
/* renamed from: ai.kudi.agent.settings.ui.AccountAndSettingsOptionsFragment$onViewCreated$2 */
/* loaded from: classes.dex */
final class AccountAndSettingsOptionsFragment$onViewCreated$2 extends AbstractC11802m implements InterfaceC11767l<SettingsOption, C13666w> {
    final /* synthetic */ AccountAndSettingsOptionsFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountAndSettingsOptionsFragment$onViewCreated$2(AccountAndSettingsOptionsFragment accountAndSettingsOptionsFragment) {
        super(1);
    ...
    public final void invoke2(SettingsOption settingsOption) {
        ...
        AccountAndSettingsOptionsViewModel $r2 = $r3.getAccountAndSettingsOptionsViewModel();
        $r2.onOptionItemClicked(settingsOption);
    }
}
