...
/* renamed from: ai.kudi.agent.settings.ui.adapters.TwoColumnTableAdapter$clickEvent$1 */
/* loaded from: classes.dex */
final class TwoColumnTableAdapter$clickEvent$1 extends AbstractC11802m implements InterfaceC11767l<TwoColumnTableAdapter.TwoColumnClickListeners, C13666w> {
    public static final TwoColumnTableAdapter$clickEvent$1 INSTANCE;

    /* JADX WARN: Can't parse signature for local variable: 
    java.lang.NullPointerException
     */
    static {
        TwoColumnTableAdapter$clickEvent$1 $r0 = new TwoColumnTableAdapter$clickEvent$1();
        INSTANCE = $r0;
    }

    TwoColumnTableAdapter$clickEvent$1() {
        super(1);
    }
