...
/* renamed from: ai.kudi.agent.settings.personal.ui.EditProfileFragment$showStates$1$1 */
/* loaded from: classes.dex */
public final class EditProfileFragment$showStates$1$1 extends AbstractC11802m implements InterfaceC11767l<String, C13666w> {
    final /* synthetic */ StateFragment $statesFragment;
    final /* synthetic */ EditProfileFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EditProfileFragment$showStates$1$1(EditProfileFragment editProfileFragment, StateFragment stateFragment) {
        super(1);
    ...
    public final void invoke2(String str) {
        ...
        KudiInputField $r5 = $r4.stateView;
        $r5.setText(str);
