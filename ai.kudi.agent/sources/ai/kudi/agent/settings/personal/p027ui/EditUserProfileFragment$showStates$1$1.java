...
/* renamed from: ai.kudi.agent.settings.personal.ui.EditUserProfileFragment$showStates$1$1 */
/* loaded from: classes.dex */
public final class EditUserProfileFragment$showStates$1$1 extends AbstractC11802m implements InterfaceC11767l<String, C13666w> {
    final /* synthetic */ StateFragment $statesFragment;
    final /* synthetic */ EditUserProfileFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EditUserProfileFragment$showStates$1$1(EditUserProfileFragment editUserProfileFragment, StateFragment stateFragment) {
        super(1);
