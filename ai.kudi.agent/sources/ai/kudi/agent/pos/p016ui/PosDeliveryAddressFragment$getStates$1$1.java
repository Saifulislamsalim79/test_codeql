...
/* renamed from: ai.kudi.agent.pos.ui.PosDeliveryAddressFragment$getStates$1$1 */
/* loaded from: classes.dex */
public final class PosDeliveryAddressFragment$getStates$1$1 extends AbstractC11802m implements InterfaceC11767l<String, C13666w> {
    final /* synthetic */ StateFragment $statesFragment;
    final /* synthetic */ PosDeliveryAddressFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PosDeliveryAddressFragment$getStates$1$1(PosDeliveryAddressFragment posDeliveryAddressFragment, StateFragment stateFragment) {
        super(1);
    ...
    public final void invoke2(String str) {
        ...
        InterfaceC8209a $r5 = $r42.requireBinding();
        FragmentPosChangeAddressBinding $r6 = (FragmentPosChangeAddressBinding) $r5;
        KudiInputField $r7 = $r6.statesField;
        $r7.setText(str);
