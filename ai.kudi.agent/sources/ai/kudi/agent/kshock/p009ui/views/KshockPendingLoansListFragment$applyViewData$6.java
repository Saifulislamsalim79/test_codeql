...
/* renamed from: ai.kudi.agent.kshock.ui.views.KshockPendingLoansListFragment$applyViewData$6 */
/* loaded from: classes.dex */
public final class KshockPendingLoansListFragment$applyViewData$6 extends AbstractC11802m implements InterfaceC11767l<Loan, C13666w> {
    final /* synthetic */ KshockPendingLoansListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KshockPendingLoansListFragment$applyViewData$6(KshockPendingLoansListFragment kshockPendingLoansListFragment) {
        super(1);
    ...
    public final void invoke2(Loan loan) {
        ...
        KshockPendingLoansListFragment $r2 = this.this$0;
        $r2.paybackLoan(loan);
    }
}
