package io.intercom.com.google.gson.p418t.p419n.p420o;

import java.util.TimeZone;
/* compiled from: ISO8601Utils.java */
/* renamed from: io.intercom.com.google.gson.t.n.o.a */
/* loaded from: classes3.dex */
public class C11054a {

    /* renamed from: a */
    private static final TimeZone f25129a = TimeZone.getTimeZone("UTC");

    /* renamed from: a */
    private static boolean m11670a(String str, int i, char c) {
        return i < str.length() && str.charAt(i) == c;
    }

    /* renamed from: b */
    private static int m11669b(String str, int i) {
        while (i < str.length()) {
    ...
    */
    public static java.util.Date m11668c(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        /*
            Method dump skipped, instructions count: 553
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: io.intercom.com.google.gson.p418t.p419n.p420o.C11054a.m11668c(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: d */
    private static int m11667d(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
