    ...
    */
    private java.lang.String escapedAV() {
        ...
        L9b:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.intercom.okhttp3.internal.tls.DistinguishedNameParser.escapedAV():java.lang.String");
    }
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f25139dn);
            } else {
                i2 = c - '7';
            }
    ...
    private char getEscaped() {
        ...
        throw new IllegalStateException("Unexpected end of DN: " + this.f25139dn);
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f25139dn.toCharArray();
