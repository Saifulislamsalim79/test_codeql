...
/* renamed from: io.intercom.okhttp3.internal.ws.WebSocketProtocol */
...
public final class WebSocketProtocol {
    ...
    public static String acceptHeader(String str) {
        return C11152f.m11539n(str + ACCEPT_MAGIC).mo11472A().mo11462a();
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void toggleMask(C11146c.C11149c c11149c, byte[] bArr) {
        int length = bArr.length;
        int i = 0;
        do {
            byte[] bArr2 = c11149c.f25213w;
            int i2 = c11149c.f25214x;
            int i3 = c11149c.f25215y;
            while (i2 < i3) {
                int i4 = i % length;
