...
import p425j.p429b.p433b.C11156j;
...
public final class PublicSuffixDatabase {
    ...
    private void readTheList() throws IOException {
        ...
        InterfaceC11151e m11526d = C11158l.m11526d(new C11156j(C11158l.m11519k(resourceAsStream)));
        try {
            byte[] bArr = new byte[m11526d.readInt()];
            m11526d.readFully(bArr);
            byte[] bArr2 = new byte[m11526d.readInt()];
            m11526d.readFully(bArr2);
            synchronized (this) {
