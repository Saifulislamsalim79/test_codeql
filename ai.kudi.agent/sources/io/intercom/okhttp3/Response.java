...
public final class Response implements Closeable {
    ...
    public ResponseBody peekBody(long j) throws IOException {
        InterfaceC11151e source = this.body.source();
        source.mo11495e(j);
        C11146c clone = source.mo11496d().clone();
        if (clone.m11579J0() > j) {
            C11146c c11146c = new C11146c();
            c11146c.write(clone, j);
            clone.m11568c();
            clone = c11146c;
        }
        return ResponseBody.create(this.body.contentType(), clone.m11579J0(), clone);
    }
