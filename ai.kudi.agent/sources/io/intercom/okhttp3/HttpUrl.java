...
public final class HttpUrl {
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i3 < i2) {
            ...
            c11146c.m11555l1(str, i, i3);
            canonicalize(c11146c, str, i3, i2, str2, z, z2, z3, z4, charset);
            return c11146c.m11584D0();
        }
    ...
    static String percentDecode(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            if (charAt == '%' || (charAt == '+' && z)) {
                C11146c c11146c = new C11146c();
                c11146c.m11555l1(str, i, i3);
                percentDecode(c11146c, str, i3, i2, z);
                return c11146c.m11584D0();
            }
        }
        return str.substring(i, i2);
    ...
    static void canonicalize(C11146c c11146c, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        C11146c c11146c2 = null;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (!z || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                if (codePointAt == 43 && z3) {
                    c11146c.m11556k1(z ? "+" : "%2B");
                    ...
                    c11146c.m11554m1(codePointAt);
                } else {
                    if (c11146c2 == null) {
                        c11146c2 = new C11146c();
                    }
                    if (charset != null && !charset.equals(Util.UTF_8)) {
                        c11146c2.m11558i1(str, i, Character.charCount(codePointAt) + i, charset);
                    } else {
                        c11146c2.m11554m1(codePointAt);
                    }
                    while (!c11146c2.mo11491l()) {
                        int readByte = c11146c2.readByte() & 255;
                        c11146c.m11567c1(37);
                        c11146c.m11567c1(HEX_DIGITS[(readByte >> 4) & 15]);
                        c11146c.m11567c1(HEX_DIGITS[readByte & 15]);
                    }
                }
            }
    ...
    static void percentDecode(C11146c c11146c, String str, int i, int i2, boolean z) {
        int i3;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37 && (i3 = i + 2) < i2) {
                ...
                if (decodeHexDigit != -1 && decodeHexDigit2 != -1) {
                    c11146c.m11567c1((decodeHexDigit << 4) + decodeHexDigit2);
                    i = i3;
                }
                c11146c.m11554m1(codePointAt);
            } else {
