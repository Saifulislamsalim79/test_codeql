...
public class ScreenUtils {
    ...
    public static Point getScreenDimensions(Context context) {
        Point $r0 = new Point();
        Object $r2 = context.getSystemService("window");
        WindowManager $r3 = (WindowManager) $r2;
        Display $r4 = $r3.getDefaultDisplay();
        $r4.getSize($r0);
        return $r0;
    }
