...
public class TaggingSocketFactory extends SocketFactory {
    ...
    public Socket createSocket() throws IOException {
        SocketFactory $r1 = this.defaultFactory;
        Socket $r2 = $r1.createSocket();
        return withTag($r2);
    }
    ...
    public Socket createSocket(String str, int i) throws IOException, UnknownHostException {
        SocketFactory $r1 = this.defaultFactory;
        Socket $r3 = $r1.createSocket(str, i);
        return withTag($r3);
    }
    ...
    public Socket createSocket(String str, int i, InetAddress inetAddress, int i2) throws IOException, UnknownHostException {
        SocketFactory $r2 = this.defaultFactory;
        Socket $r4 = $r2.createSocket(str, i, inetAddress, i2);
        return withTag($r4);
    }
    ...
    public Socket createSocket(InetAddress inetAddress, int i) throws IOException {
        SocketFactory $r1 = this.defaultFactory;
        Socket $r3 = $r1.createSocket(inetAddress, i);
        return withTag($r3);
    }
    ...
    public Socket createSocket(InetAddress inetAddress, int i, InetAddress inetAddress2, int i2) throws IOException {
        SocketFactory $r2 = this.defaultFactory;
        Socket $r4 = $r2.createSocket(inetAddress, i, inetAddress2, i2);
        return withTag($r4);
    }
}
