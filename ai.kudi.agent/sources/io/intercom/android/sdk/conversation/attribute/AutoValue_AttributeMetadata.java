...
public final class AutoValue_AttributeMetadata extends AttributeMetadata {
    ...
    public boolean equals(Object obj) {
        ...
        boolean $z0 = obj instanceof AttributeMetadata;
        if ($z0) {
            AttributeMetadata $r2 = (AttributeMetadata) obj;
            int $i0 = this.position;
            int $i1 = $r2.getPosition();
            if ($i0 == $i1) {
                int $i02 = this.totalCount;
                int $i12 = $r2.getTotalCount();
                return $i02 == $i12;
            }
            return false;
        }
    ...
    public String toString() {
        ...
        $r2.append("AttributeMetadata{position=");
        int $i0 = this.position;
        $r2.append($i0);
