...
public class NotificationChannelsCard implements Parcelable {
    public static final Parcelable.Creator<NotificationChannelsCard> CREATOR = new Parcelable.Creator<NotificationChannelsCard>() { // from class: io.intercom.android.sdk.blocks.models.NotificationChannelsCard.1
        ...
        public NotificationChannelsCard createFromParcel(Parcel parcel) {
            NotificationChannelsCard $r2 = new NotificationChannelsCard(parcel);
            return $r2;
        }
         ...
         */
        @Override // android.os.Parcelable.Creator
        public /* bridge */ /* synthetic */ NotificationChannelsCard createFromParcel(Parcel parcel) {
            NotificationChannelsCard $r1 = createFromParcel(parcel);
            return $r1;
        }
        ...
        public NotificationChannelsCard[] newArray(int i) {
            NotificationChannelsCard[] $r1 = new NotificationChannelsCard[i];
            return $r1;
        }
         ...
         */
        @Override // android.os.Parcelable.Creator
        public /* bridge */ /* synthetic */ NotificationChannelsCard[] newArray(int i) {
            NotificationChannelsCard[] $r1 = newArray(i);
            return $r1;
        }
    };
    ...
    public static final class Builder {
        ...
        public NotificationChannelsCard build() {
            NotificationChannelsCard $r1 = new NotificationChannelsCard(this);
            return $r1;
        }
    ...
    */
    NotificationChannelsCard() {
        /*
            r1 = this;
            io.intercom.android.sdk.blocks.models.NotificationChannelsCard$Builder r0 = new io.intercom.android.sdk.blocks.models.NotificationChannelsCard$Builder
            r0.<init>()
            r1.<init>(r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.intercom.android.sdk.blocks.models.NotificationChannelsCard.<init>():void");
    }
    ...
    protected NotificationChannelsCard(Parcel parcel) {
        ...
        this.title = $r42;
        Parcelable.Creator $r5 = Channel.CREATOR;
        ArrayList $r6 = parcel.createTypedArrayList($r5);
        this.channels = $r6;
    }
    ...
    private NotificationChannelsCard(Builder builder) {
        ...
        BlockType $r1 = $r3 == null ? BlockType.NOTIFICATIONCHANNELSCARD : BlockType.typeValueOf($r3);
        this.type = $r1;
        String $r4 = builder.text;
        this.text = $r4 == null ? "" : $r4;
        String $r42 = builder.title;
        this.title = $r42 != null ? $r42 : "";
        Object $r5 = builder.channels;
        if ($r5 == null) {
            $r5 = r6;
            Object r6 = new ArrayList();
        }
        List r7 = (List) $r5;
        this.channels = r7;
    }
    ...
    public static NotificationChannelsCard fromBlock(Block block) {
        if (block == null) {
            NotificationChannelsCard $r2 = new NotificationChannelsCard();
            return $r2;
        }
        ...
        String $r4 = $r3.name();
        $r0.type = $r4;
        String $r42 = block.getTitle();
        $r0.title = $r42;
        String $r43 = block.getText();
        $r0.text = $r43;
        List $r5 = block.getChannels();
        $r0.channels = $r5;
        NotificationChannelsCard $r22 = new NotificationChannelsCard($r0);
        return $r22;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null) {
            ...
            if (NotificationChannelsCard.class != $r2) {
                return false;
            }
            NotificationChannelsCard $r3 = (NotificationChannelsCard) obj;
            ...
            List $r8 = this.channels;
            List $r9 = $r3.channels;
            if ($r8 == null) {
                return $r9 == null;
            }
            boolean $z03 = $r8.equals($r9);
            return $z03;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        $r2.append("NotificationChannelsCard{type=");
    ...
    public void writeToParcel(Parcel parcel, int i) {
        BlockType $r2 = this.type;
        int $i0 = $r2 == null ? -1 : $r2.ordinal();
        parcel.writeInt($i0);
        String $r3 = this.text;
