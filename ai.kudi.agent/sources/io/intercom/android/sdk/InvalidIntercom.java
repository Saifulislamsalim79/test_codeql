...
public class InvalidIntercom extends Intercom {
    ...
    private void logIncorrectInitialisationWarning() {
        this.twig.m13068e("Intercom has been initialized incorrectly. Please make sure the first Intercom method you call is initialize() and that you're passing in the correct app ID and API key", new Object[0]);
    }
