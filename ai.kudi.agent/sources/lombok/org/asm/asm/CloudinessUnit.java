...
public final class CloudinessUnit extends AbstractC11802m implements InterfaceC11771p<t, InterfaceC11719g.InterfaceC11722b, t> {
    public static final CloudinessUnit PERCENT;

    /* JADX WARN: Can't parse signature for local variable: 
    java.lang.NullPointerException
     */
    static {
        CloudinessUnit $r0 = new CloudinessUnit();
        PERCENT = $r0;
    }

    public CloudinessUnit() {
        super(2);
    }
